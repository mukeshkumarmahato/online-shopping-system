							...
							<div id="tab1" class="tab-pane active">
								<div class="products-slick" data-nav="#slick-nav-1" >
									<?php
										...
										$product_query = "SELECT * FROM products,categories WHERE product_cat=cat_id AND product_id BETWEEN 71 AND 79";
						...
						<div id="get_product_home2">
							<div class="product-widget">
								...
								<div class="product-body">
									...
									<h4 class="product-price">$ 55000.00</h4>
								</div>
							</div>
							<div class="product-widget">
								<div class="product-img">
							...
							<div class="product-widget">
								...
								<div class="product-body">
									<p class="product-category">Electronics</p>
									<h3 class="product-name"><a href="#">HP i7 laptop 8gb ram</a></h3>
									<h4 class="product-price">$ 55000.00</h4>
								</div>
							</div>
						</div>
					...
					<div class="products-widget-slick" data-nav="#slick-nav-4">
						<div>
							<div class="product-widget">
								...
								<div class="product-body">
									<p class="product-category">Electronics</p>
									<h3 class="product-name"><a href="#">sony note 6gb ram</a></h3>
									<h4 class="product-price">$ 45000.00</h4>
								</div>
							</div>
							<div class="product-widget">
								<div class="product-img">
							...
							<div class="product-widget">
								...
								<div class="product-body">
									<p class="product-category">Electronics</p>
									<h3 class="product-name"><a href="#">MSV laptop 16gb ram NVIDEA Graphics</a></h3>
						...
						<div>
							...
							<div class="product-widget">
								...
								<div class="product-body">
									<p class="product-category">Electronics</p>
									<h3 class="product-name"><a href="#">dell laptop 8gb ram intel integerated Graphics</a></h3>
									<h4 class="product-price">$ 45000.00</h4>
								</div>
							</div>
							<div class="product-widget">
								...
								<div class="product-body">
									<p class="product-category">Electronics gadgets</p>
									<h3 class="product-name"><a href="#">camera with 3D pixels</a></h3>
									<h4 class="product-price">$ 2500.00</h4>
								</div>
							</div>
						</div>
