			...
			echo '
				<div class="main ">
					...
					echo '
						...
						<form action="http://www.sandbox.paypal.com/cgi-bgi/webscr" method="post">
							<input type="hidden" name="cmd" value="_cart">
							<input type="hidden" name="business" value="myonlineshop121@gmail.com">
							...
							while($row=mysqli_fetch_array($query)){
								...
								echo   
									'<input type="hidden" name="return_url" value="http://localhost/online-shop-system/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/online-shop-system/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/online-shop-system/cancel.php"/>
									<input type="hidden" name="currency_code" value="USD"/>
									<input type="hidden" name="paypal_url" value="http://www.sandbox.paypal.com/cgi-bgi/webscr"/>
